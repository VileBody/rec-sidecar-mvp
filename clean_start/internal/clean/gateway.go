...
func (g *Gateway) Run(ctx context.Context) error {
	...
	mux.HandleFunc("GET /v1/admin/prompt-configs/{user_type}/{kind}/{key}", g.getPromptConfig)
	mux.HandleFunc("PUT /v1/admin/prompt-configs/{user_type}/{kind}/{key}", g.upsertPromptConfig)
