...
Формат: один цельный ответ, без fast/slow частей, без markdown, без списков и заголовков. Отвечай на языке вопроса; если вопроса нет, отвечай по-русски."""
...
- Не используй markdown bullets, нумерованные списки, жирный текст, stage, scorecard, продающие скрипты или коучинг продавца.
