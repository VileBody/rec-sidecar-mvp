...
Формат абсолютно строгий: верни только саму фразу на русском, без кавычек, без Markdown, без пояснений, без вариантов. Ровно одно предложение, до 30 слов. Если получается второе предложение, перепиши в одно."""
